...
$(call inherit-product-if-exists, vendor/agm/AGMA3EU/AGMA3EU-vendor.mk)
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/audio/etc/audio_effects.conf:system/etc/audio_effects.conf \
    $(LOCAL_PATH)/audio/etc/audio_platform_info.xml:system/etc/audio_platform_info.xml \
    $(LOCAL_PATH)/audio/etc/audio_platform_info_extcodec.xml:system/etc/audio_platform_info_extcodec.xml \
